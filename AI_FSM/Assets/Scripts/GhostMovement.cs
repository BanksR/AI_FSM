...
public class GhostMovement : MonoBehaviour
{
    ...
    {
	    // This coroutine acts as a buffer between states;
	    // it will send the ghost wandering off in a random direction once contact has been lost
        currentState = State.Idle;
	...
	private float GetDistance()
	{
		...
		// This function could be expanded / improved by casting a Ray from the ghost
		// to the player - the ghost could then require line-of-sight to the player
